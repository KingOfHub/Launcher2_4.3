...
class AllAppsList {
    ...
    public static final String LAUNCHER_CONTROL_MAIL189 = "persist.env.launcher.mail189";
    public static final boolean mMail189Enabled =
        SystemProperties.getBoolean(LAUNCHER_CONTROL_MAIL189, false);
    ...
    public void add(ApplicationInfo info) {
        ...
        if (info.componentName.getPackageName().equals("com.google.android.gms")) {
            // nothing
        } else {
            data.add(info);
            added.add(info);
