...
public class Workspace extends SmoothPagedView
    ...
    public Workspace(Context context, AttributeSet attrs, int defStyle) {
        ...
        cellCountY = DEFAULT_CELL_COUNT_Y;
    ...
    */
    ...
    Animator getChangeStateAnimation(final State state, boolean animated, int delay) {
        ...
        if(mDisplayWallPaperInAllApp) {
            ...
            if(stateIsSmall) {
                if (dockDivider != null) dockDivider.animate().alpha(0f).setDuration(duration);
            } else {
                if (dockDivider != null) dockDivider.setAlpha(1f);
            }
        }
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if(mDisplayWallPaperInAllApp && stateIsSmall) {
                finalAlpha = 0f;
            }
