...
public class LauncherModel extends BroadcastReceiver {
    ...
    private static LoaderTask mLoaderTask;
    ...
    private SharedPreferences myAppsharedPreferences;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Intent.ACTION_PACKAGE_CHANGED.equals(action)
           ...
           if( packageName.equals("com.android.email")||packageName.equals("com.caf.fmradio")) {
               return;
           }
    ...
    private class LoaderTask implements Runnable {
        ...
        private void onlyBindAllApps() {
           ...
           // @SuppressWarnings("unchecked")
            if(Build.PROJECT.equals("ID85")) {
                  ...
                  SharedPreferences LauncherApps= mContext.getSharedPreferences("LauncherApps", mContext.MODE_PRIVATE);
                  ...
                  for (String str : app_list) {
            	      for(int j=0;j<i;j++) {   
            		      ApplicationInfo appInfo = new ApplicationInfo(mpackageManager, mapps.get(j), mIconCache,mLabelCache);
            		      if (appInfo.componentName.getPackageName().equals(str)) {
             	                   mBgAllAppsList.add(new ApplicationInfo(mpackageManager, mapps.get(j),
        ...
        private void loadAllAppsByBatch() {
         ...
         if (Build.PROJECT.equals("ID85")) {
                ...
                if(applist.equals("")){
                    String firstlist="com.android.contacts,com.android.dialer,com.android.gallery3d,com.android.gallery3d,com.android.mms,com.android.settings,com.sohu.inputmethod.sogou,com.android.qrdfileexplorer,com.example.urovoscan,";                 
                    edit.putString("AllowedClassNames", firstlist);
                    edit.commit();
                }
                applist=LauncherApps.getString("AllowedClassNames", "");
                String[] app_list = applist.split(","); 
                startIndex = i;
                for (int j=0; i<N && j<batchSize; j++) {
                        ...
                        ApplicationInfo appInfo = new ApplicationInfo(packageManager, apps.get(i), mIconCache,mLabelCache);
                        for (String str : app_list)
                        {
                          if (appInfo.componentName.getPackageName().equals(str)) {
                ...
                for (int j=0; i<N && j<batchSize; j++) {
                    ...
                    // 20140403 Hide App icon to launcher --liao
                    ApplicationInfo appInfo = new ApplicationInfo(packageManager, apps.get(i), mIconCache,mLabelCache);
                    if (appInfo.componentName.getClassName().equals("com.google.android.gms.app.settings.GoogleSettingsActivity")) {
				        // do nothing
                    } else if (appInfo.componentName.getClassName().equals("com.android.development.Development")) {
				        // do nothing
                    } else if (Build.PROJECT.equals("A862") && Build.PWV_CUSTOM_CUSTOM.equals("RCA") && appInfo.componentName.getClassName().equals("com.android.dialer.DialtactsActivity")) {
				        // do nothing
                    } else {
                        mBgAllAppsList.add(new ApplicationInfo(packageManager, apps.get(i),
                                mIconCache, mLabelCache));
        ...
        case LauncherSettings.Favorites.ICON_TYPE_RESOURCE:
            ...
            try {
                intent = Intent.parseUri(c.getString(intentIndex), 0);
                    ...
                    Log.d(TAG, "get intent has exception");
            }
            ...
            if (intent != null) {
                ...
                try {
                    ...
                    Log.d(TAG, "activity not found: " + componentName);
                }
