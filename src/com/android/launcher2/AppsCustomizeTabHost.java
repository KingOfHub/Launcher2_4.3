...
public class AppsCustomizeTabHost extends TabHost implements LauncherTransitionable,
    ...
    public static final boolean REMOVE_WIDGET = Build.PROJECT.equals("SQ27D") || Build.PWV_CUSTOM_CUSTOM.equals("UMSPOS") || Build.PWV_CUSTOM_CUSTOM.equals("WJ") || Build.PWV_CUSTOM_CUSTOM.equals("WD") || Build.PWV_CUSTOM_CUSTOM.equals("GZJ") || Build.PWV_CUSTOM_CUSTOM.equals("SYB");
    ...
    protected void onFinishInflate() {
	    ...
	    if(REMOVE_WIDGET) {
			...
			tabView.setText(label);
			tabView.setContentDescription(label);
			addTab(newTabSpec(WIDGETS_TAB_TAG).setIndicator(tabView)
